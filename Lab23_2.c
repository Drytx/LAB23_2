...
int main() {
	...
	addelem(vars, "Adam"); addelem(vars, "Albert"); addelem(vars, "David"); addelem(vars, "Viliam"); addelem(vars, "Michael"); addelem(vars, "Saкк"); addelem(vars, "Sara"); addelem(vars, "Sara");
	addelem(vars, "Михаил"); addelem(vars, "Денис");
	listprint(vars);
}
struct list* init(char name[80])
{
